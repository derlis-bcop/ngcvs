...
### 12. Metodología de Alineación Temprana con Producción e Infraestructura (Resumen)

Todo proyecto tecnológico deberá aplicar obligatoriamente la Metodología de Alineación Temprana con Producción e Infraestructura, iniciando su participación desde la fase de idea y manteniendo validaciones continuas durante todo el ciclo de vida.  
La Gerencia de Producción/Infraestructura participa en el diseño de despliegue, monitoreo, health checks, métricas, telemetría y rollback, y debe emitir una Pre-Aprobación de Despliegue para cualquier promoción a PRE-PROD o PROD.  
La metodología incorpora el **Checklist CETI (Checklist de Elegibilidad Técnica Inicial)**, cuya aprobación es obligatoria para iniciar cualquier proyecto, garantizando su viabilidad técnica, operativa, de seguridad y de infraestructura.

*El detalle completo de esta metodología, sus responsabilidades, validaciones y procesos se desarrolla en el Manual Técnico MT-12 — Metodología de Alineación Temprana con Producción e Infraestructura, y su Checklist de Nivel 3.*
